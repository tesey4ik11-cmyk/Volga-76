...
/**
 * Наполнение шаблонов типовых объектов (Мурава, Каркасник, Сваи, Терраса и т.д.)
 */
function vgs_seed_templates($pdo)
{
    $templates = array(
        array(
            'code' => 'murava',
            'name' => 'Технический блок «Мурава»',
            'default_area' => 50.0,
            'description' => 'Эталонный технический блок 50 м²: свайный фундамент, перекрытия пола, сэндвич-панели стен, кровля PIR и проектная документация (ровно 680 172 ₽).',
            'options' => array(
